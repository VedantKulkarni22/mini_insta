        ...
        <div>
            <div className="crd card text-center mx-auto mt-3 mb-3">
                <div className="card-body">
                    <a href='/signup'><img className='InstaLogo img-fluid p-4' src='Images/InstaLogo.png' alt="instalogo"></img></a>
                    ...
                    <form className='px-4'>
                        ...
                        <div className='mb-2' style={{fontSize: "x-small"}}>People who use our service may have uploaded your contact information to Instagram.<Link to='/signup'> Learn More</Link></div>
                        <div className='mb-2' style={{fontSize: "x-small"}}>By signing up, you agree to our<Link to='/signup'> Terms</Link>,<Link to='/signup'> Privacy Policy</Link> and <Link to='/signup'>Cookies Policy</Link>. </div>
            ...
            <div className="crd card text-center mx-auto mt- mb-3">
                <div className="card-body">
                    <div>Have an account? <Link className='loginlnk' to='/login'><span className='logintxt'>Log in</span></Link></div>
                </div>
            </div>
        </div>
    )
